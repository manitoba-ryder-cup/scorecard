...
// ResetMatchScores clears every score on a match and its stored result, returning it to
// never-played. The lineup stays. A 204 (no body) is success; 404 if the match is unknown.
